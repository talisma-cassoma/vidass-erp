    ...
    <Sidebar collapsible="icon" {...props}>
      ...
      <SidebarHeader>
        ...
        >
          ...
          <div 
            className={cn(
              "flex-shrink-0 border rounded-full max-w-8 max-h-8 transition-transform duration-500",
              isExpanded && "rotate-[360deg]",
            )}
          >
            <img src="https://our-ngo.vercel.app/logo.png" alt="Vidass logo" className="h-auto w-auto rounded-full" >
          </img>
          </div>
          ...
          >
            {process.env.NEXT_PUBLIC_APP_NAME || "Vidass ERP"}
          </h1>
        </div>
      </SidebarHeader>
